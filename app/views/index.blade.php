...
@if($posts->getCurrentPage() === 1)
	...
	@elseif ($i === 3)
		<li class="column grid1 alt2"><a href="/{{ $p->filename }}"><img src="{{ $cdn_path . $p->filename}}_560.jpg"></a></li>
	@elseif ($i === 4)
		<li class="column grid1 alt1"><a href="/{{ $p->filename }}"><img src="{{ $cdn_path . $p->filename}}_560.jpg"></a></li>
	@else
		<li class="column grid1"><a href="/{{ $p->filename }}"><img src="{{ $cdn_path . $p->filename}}_560.jpg"></a></li>
	@endif
@else
